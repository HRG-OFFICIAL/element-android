...
Java_com_example_RASP_NativeObfuscator_a(JNIEnv *env, jclass clazz) {
    inject_dead_code();
...
JNIEXPORT jboolean JNICALL
Java_com_example_RASP_NativeObfuscator_b(JNIEnv *env, jclass clazz) {
    inject_dead_code();
...
Java_com_example_RASP_NativeObfuscator_c(JNIEnv *env, jclass clazz, jstring encrypted_hex) {
    inject_dead_code();
...
JNIEXPORT jboolean JNICALL
Java_com_example_RASP_NativeObfuscator_d(JNIEnv *env, jclass clazz) {
    inject_dead_code();
    ...
    if (opaque_true()) {
        ...
        if (self_handle) {
            void* func_ptr = dlsym(self_handle, "Java_com_example_RASP_NativeObfuscator_a");
...
Java_com_example_RASP_NativeObfuscator_e(JNIEnv *env, jclass clazz) {
    if (opaque_true()) {
        // Disable core dumps
