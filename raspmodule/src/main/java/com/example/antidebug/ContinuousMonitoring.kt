...
class ContinuousMonitoring(private val context: Context) {
    ...
    fun initialize(
        ...
        registerDetectionModule("debugger", debuggerDetection::isDebuggerAttached, RASP.ThreatType.DEBUGGER, 5)
        registerDetectionModule("root", rootDetection::isDeviceRooted, RASP.ThreatType.ROOT, 6)
        registerDetectionModule("emulator", emulatorDetection::isEmulator, RASP.ThreatType.EMULATOR, 4)
        registerDetectionModule("tamper", tamperDetection::isApplicationTampered, RASP.ThreatType.TAMPERING, 7)
        registerDetectionModule("hook", hookDetection::isHookingDetected, RASP.ThreatType.HOOKS, 5)
        registerDetectionModule("behavioral", behavioralAnalysis::isSuspiciousBehaviorDetected, RASP.ThreatType.SUSPICIOUS_BEHAVIOR, 3)
...
data class DetectionModule(
    ...
    val threatType: RASP.ThreatType,
    val severity: Int,
